...
AWS_SUBNET_ID0=$(aws ec2 describe-subnets --filters Name=vpc-id,Values=$AWS_VPC_ID --output text --query 'Subnets[0].SubnetId')
aws ec2 delete-subnet --subnet-id $AWS_SUBNET_ID0
